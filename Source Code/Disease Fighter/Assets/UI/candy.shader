...
Shader "Shadero Customs/candy"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
AnimatedTwistUV_AnimatedTwistUV_Bend_1("AnimatedTwistUV_AnimatedTwistUV_Bend_1", Range(-1, 1)) = 0.146
...
AnimatedTwistUV_AnimatedTwistUV_Speed_1("AnimatedTwistUV_AnimatedTwistUV_Speed_1", Range(-10, 10)) = 2.571
...
float4 OperationBlend_1 = OperationBlend(NewTex_1, float4(1,1,0,1), _OperationBlend_Fade_1); 
