...
Shader "Shadero Customs/FireCircle_button"
{
Properties
{
...
float4 _PremadeGradients_1 = Color_PreGradients(_CircleFade_2,float4(0.5,0.5,0.5,1),float4(0.5,0.5,0.5,1),float4(0.8,0.8,0.8,1),float4(0,0.33,0.67,1),0,1,0);
